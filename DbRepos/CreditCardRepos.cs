...
// public class CreditCardDbRepos
// {
...
//     public async Task<ResponsePageDto<ICreditCard>> ReadItemsAsync(bool seeded, bool flat, string filter, int pageNumber, int pageSize)
//     {
//         filter ??= "";
//         IQueryable<CreditCardDbM> query;
//         if (flat)
