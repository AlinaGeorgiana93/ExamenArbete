...
public class SleepLevelServiceDb : ISleepLevelService
{
    ...
    public Task<ResponsePageDto<ISleepLevel>> ReadSleepsLevelsAsync(bool flat, string filter, int pageNumber, int pageSize) => _sleeplevelRepo.ReadItemsAsync(flat, filter, pageNumber, pageSize);
