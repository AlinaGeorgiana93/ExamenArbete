...
public class AppetiteLevelServiceDb : IAppetiteLevelService {
    ...
    public Task<ResponsePageDto<IAppetiteLevel>> ReadAppetiteLevelsAsync(bool seeded, bool flat, string filter, int pageNumber, int pageSize) => _appetitelevelRepo.ReadItemsAsync(seeded, flat, filter, pageNumber, pageSize);
