...
public class StaffServiceDb : IStaffService
{
 ...
 public StaffServiceDb(StaffDbRepos staffRepo, ILogger<StaffServiceDb> logger)
    ...
    public Task<ResponsePageDto<IStaff>> ReadStaffsAsync(bool seeded, bool flat, string filter, int pageNumber, int pageSize) => _staffRepo.ReadItemsAsync(seeded, flat, filter, pageNumber, pageSize);
