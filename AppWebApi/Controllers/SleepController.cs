...
namespace AppWebApi.Controllers
{
    ...
    public class SleepController : Controller
    {
        ...
        [HttpGet()]
        [ProducesResponseType(200, Type = typeof(ResponseItemDto<ISleep>))]
        [ProducesResponseType(400, Type = typeof(string))]
        ...
        [HttpGet()]
        [ProducesResponseType(200, Type = typeof(ResponseItemDto<SleepCuDto>))]
        [ProducesResponseType(400, Type = typeof(string))]
        [ProducesResponseType(404, Type = typeof(string))]
        ...
        [ProducesResponseType(200, Type = typeof(ResponseItemDto<ISleep>))]
        [ProducesResponseType(400, Type = typeof(string))]
        public async Task<IActionResult> UpdateItem(string id, [FromBody] SleepCuDto item)
        {
            try
            {
                var idArg = Guid.Parse(id);
        ...
        [ProducesResponseType(200, Type = typeof(ResponseItemDto<ISleep>))]
        [ProducesResponseType(400, Type = typeof(string))]
        public async Task<IActionResult> CreateItem([FromBody] SleepCuDto item)
        {
            try
            {
